...
// Package tests implements execution of Dnp JSON tests.
package tests
...
/* See https://github.com/xdn/tests/wiki/Blockchain-Tests-II

   Whxdner a block is valid or not is a bit subtle, it's defined by presence of
