...
import (
	...
	"github.com/xdn/go-xdn/crypto/ecies"
	"github.com/xdn/go-xdn/event/filter"
...
// Whisper represents a dark communication interface through the Dnp
...
type Whisper struct {
	...
	expirations map[uint32]*set.SetNonTS  // Message expiration pool (TODO: somxdning lighter)
...
// New creates a Whisper client ready to communicate through the Dnp P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
