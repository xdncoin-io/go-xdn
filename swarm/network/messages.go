...
import (
	...
	"github.com/xdn/go-xdn/swarm/network/kademlia"
	"github.com/xdn/go-xdn/swarm/services/swap"
...
Timeout serves to indicate whxdner the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whxdner responder is expected to deliver content
