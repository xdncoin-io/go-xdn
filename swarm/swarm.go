...
import (
	...
	"github.com/xdn/go-xdn/contracts/chequebook"
	...
	"github.com/xdn/go-xdn/swarm/api"
	httpapi "github.com/xdn/go-xdn/swarm/api/http"
	"github.com/xdn/go-xdn/swarm/fuse"
	"github.com/xdn/go-xdn/swarm/network"
	"github.com/xdn/go-xdn/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *xdnclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
