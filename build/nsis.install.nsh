...
!define HELPURL "https://github.com/dnp/go-dnp/issues"
!define UPDATEURL "https://github.com/dnp/go-dnp/releases"
!define ABOUTURL "https://github.com/dnp/go-dnp#dnp-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Dnp" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Dnp" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Dnp" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/dnp/EIPs/issues/147)
  ${EnvVarUpdate} $0 "DNP_SOCKET" "R" "HKLM" "\\.\pipe\geth.ipc"
  ${EnvVarUpdate} $0 "DNP_SOCKET" "A" "HKLM" "\\.\pipe\geth.ipc"
