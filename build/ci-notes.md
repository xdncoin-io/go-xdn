...
We want to build go-dnp with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Ednp/+archive/ubuntu/dnp/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/dnp-unstable-1.6.0+xenial
    $ dpkg-buildpackage
