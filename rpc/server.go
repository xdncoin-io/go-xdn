...
func (s *Server) RegisterName(name string, rcvr interface{}) error {
	...
	//fmt.Printf("haha:%v, %v, %v  \r\n", name, svc.typ.String(), svc.name)
	...
	//fmt.Printf("haha methods:%v, subscriptions:%v \r\n", methods, subscriptions)
...
func (s *Server) readRequest(codec ServerCodec) ([]*serverRequest, bool, Error) {
	...
	for i, r := range reqs {
		...
		if r.isPubSub { // xdn_subscribe, r.method contains the subscription method name
