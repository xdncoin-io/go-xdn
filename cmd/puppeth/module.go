...
// returned from docker inspect, parsed into a form easily usable by puppxdn.
type containerInfos struct {
	running bool              // Flag whxdner the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whxdner there's a container running for the service
	...
	// Infos retrieved, parse the above into somxdning meaningful
