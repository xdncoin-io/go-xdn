...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (xdn/61) or header (xdn/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (xdn/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both xdn/61 and xdn/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Somxdning went very wrong, drop the peer
