...
var ProtocolName = "xdn"

// Supported versions of the xdn protocol (first is primary).
var ProtocolVersions = []uint{xdn63, xdn62}
...
// xdn protocol message codes
const (
	// Protocol messages belonging to xdn/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to xdn/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
