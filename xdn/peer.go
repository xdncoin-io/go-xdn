...
// PeerInfo represents a short summary of the Dnp sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Dnp protocol version negotiated
...
// Handshake executes the xdn protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("xdn/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Dnp sub-protocol.
type peerSet struct {
