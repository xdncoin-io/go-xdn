...
// information related to the Dnp protocol such als blocks, transactions and logs.
...
// `xdn_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/xdn/wiki/wiki/JSON-RPC#xdn_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with xdn_getFilterChanges.
//
// https://github.com/xdn/wiki/wiki/JSON-RPC#xdn_newblockfilter
...
//
// https://github.com/xdn/wiki/wiki/JSON-RPC#xdn_newfilter
...
//
// https://github.com/xdn/wiki/wiki/JSON-RPC#xdn_getlogs
...
//
// https://github.com/xdn/wiki/wiki/JSON-RPC#xdn_uninstallfilter
...
//
// https://github.com/xdn/wiki/wiki/JSON-RPC#xdn_getfilterlogs
...
//
// https://github.com/xdn/wiki/wiki/JSON-RPC#xdn_getfilterchanges
