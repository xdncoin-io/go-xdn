...
type SimulatedBackend struct {
	database   xdndb.Database   // In memory database to store our testing data
	blockchain *core.BlockChain // Dnp blockchain to handle the consensus
...
func NewSimulatedBackend(alloc core.GenesisAlloc) *SimulatedBackend {
	database, _ := xdndb.NewMemDatabase()
	genesis := core.Genesis{Config: params.AllDnpashProtocolChanges, Alloc: alloc}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call xdn.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call xdn.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call xdn.CallMsg) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call xdn.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, bool, error) {
