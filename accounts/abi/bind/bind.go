...
// Package bind generates Dnp contract Go bindings.
//
// Detailed usage document and tutorial available on the go-xdn Wiki page:
// https://github.com/xdn/go-xdn/wiki/Native-DApps:-Go-bindings-to-Dnp-contracts
package bind
...
// structured checks whxdner a method has enough information to return a proper
