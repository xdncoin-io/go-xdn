...
// See https://github.com/xdn/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whxdner the event notification loop is running
...
// HasAddress reports whxdner a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Dnp presale wallet and stores
