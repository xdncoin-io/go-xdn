...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/xdn/pyxdnsaletool

		pyxdnsaletool generates the encryption key from password by
	...
	*/
	...
	xdnPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(xdnPriv)
	...
	expectedAddr := preSaleKeyStruct.DnpAddr
