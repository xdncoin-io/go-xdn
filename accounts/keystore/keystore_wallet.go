...
// Status implements accounts.Wallet, returning whxdner the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain xdn.ChainStateReader) {}
