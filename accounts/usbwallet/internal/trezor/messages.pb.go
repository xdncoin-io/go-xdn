...
const (
	...
	MessageType_MessageType_DnpGetAddress       MessageType = 56
	MessageType_MessageType_DnpAddress          MessageType = 57
	MessageType_MessageType_DnpSignTx           MessageType = 58
	MessageType_MessageType_DnpTxRequest        MessageType = 59
	MessageType_MessageType_DnpTxAck            MessageType = 60
	...
	MessageType_MessageType_DnpSignMessage      MessageType = 64
	MessageType_MessageType_DnpVerifyMessage    MessageType = 65
	MessageType_MessageType_DnpMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_DnpGetAddress",
	57:  "MessageType_DnpAddress",
	58:  "MessageType_DnpSignTx",
	59:  "MessageType_DnpTxRequest",
	60:  "MessageType_DnpTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_DnpSignMessage",
	65:  "MessageType_DnpVerifyMessage",
	66:  "MessageType_DnpMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_DnpGetAddress":       56,
	"MessageType_DnpAddress":          57,
	"MessageType_DnpSignTx":           58,
	"MessageType_DnpTxRequest":        59,
	"MessageType_DnpTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_DnpSignMessage":      64,
	"MessageType_DnpVerifyMessage":    65,
	"MessageType_DnpMessageSignature": 66,
...
// *
// Request: Ask device for Dnp address corresponding to address_n path
// @next PassphraseRequest
// @next DnpAddress
// @next Failure
type DnpGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DnpGetAddress) Reset()                    { *m = DnpGetAddress{} }
func (m *DnpGetAddress) String() string            { return proto.CompactTextString(m) }
func (*DnpGetAddress) ProtoMessage()               {}
func (*DnpGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *DnpGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DnpGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Dnp address derived from device private seed
// @prev DnpGetAddress
type DnpAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DnpAddress) Reset()                    { *m = DnpAddress{} }
func (m *DnpAddress) String() string            { return proto.CompactTextString(m) }
func (*DnpAddress) ProtoMessage()               {}
func (*DnpAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *DnpAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DnpSignTx) Reset()                    { *m = DnpSignTx{} }
func (m *DnpSignTx) String() string            { return proto.CompactTextString(m) }
func (*DnpSignTx) ProtoMessage()               {}
func (*DnpSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *DnpSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DnpSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *DnpSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *DnpSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *DnpSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *DnpSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *DnpSignTx) GetDataLength() uint32 {
...
func (m *DnpSignTx) GetChainId() uint32 {
...
func (m *DnpTxRequest) Reset()                    { *m = DnpTxRequest{} }
func (m *DnpTxRequest) String() string            { return proto.CompactTextString(m) }
func (*DnpTxRequest) ProtoMessage()               {}
func (*DnpTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *DnpTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *DnpTxRequest) GetSignatureV() uint32 {
...
func (m *DnpTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *DnpTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev DnpTxRequest
// @next DnpTxRequest
type DnpTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DnpTxAck) Reset()                    { *m = DnpTxAck{} }
func (m *DnpTxAck) String() string            { return proto.CompactTextString(m) }
func (*DnpTxAck) ProtoMessage()               {}
func (*DnpTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *DnpTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next DnpMessageSignature
// @next Failure
type DnpSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DnpSignMessage) Reset()                    { *m = DnpSignMessage{} }
func (m *DnpSignMessage) String() string            { return proto.CompactTextString(m) }
func (*DnpSignMessage) ProtoMessage()               {}
func (*DnpSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *DnpSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DnpSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *DnpVerifyMessage) Reset()                    { *m = DnpVerifyMessage{} }
func (m *DnpVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*DnpVerifyMessage) ProtoMessage()               {}
func (*DnpVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *DnpVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DnpVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *DnpVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// Response: Signed message
// @prev DnpSignMessage
type DnpMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DnpMessageSignature) Reset()                    { *m = DnpMessageSignature{} }
func (m *DnpMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*DnpMessageSignature) ProtoMessage()               {}
func (*DnpMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *DnpMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DnpMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DnpGetAddress)(nil), "DnpGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*DnpAddress)(nil), "DnpAddress")
	...
	proto.RegisterType((*DnpSignTx)(nil), "DnpSignTx")
	proto.RegisterType((*DnpTxRequest)(nil), "DnpTxRequest")
	proto.RegisterType((*DnpTxAck)(nil), "DnpTxAck")
	proto.RegisterType((*DnpSignMessage)(nil), "DnpSignMessage")
	proto.RegisterType((*DnpVerifyMessage)(nil), "DnpVerifyMessage")
	proto.RegisterType((*DnpMessageSignature)(nil), "DnpMessageSignature")
