...
// Package state provides a caching layer atop the Dnp state trie.
package state
...
// StateDBs within the xdn protocol are used to store anything
...
// Exist reports whxdner the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whxdner the state object is either non-existent
...
//
// Carrying over the balance ensures that Dnper doesn't disappear.
