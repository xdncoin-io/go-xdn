...
type Context struct {
	// CanTransfer returns whxdner the account contains
	// sufficient xdner to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers xdner from one account to the other
...
// EVM is the Dnp Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) xdn virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whxdner the max code size has been exceeded
