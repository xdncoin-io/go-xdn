...
import (
	...
	"github.com/xdn/go-xdn/crypto/bn256"
...
// PrecompiledContractsHomestead contains the default set of pre-compiled Dnp
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Dnp
...
func (c *ecrecover) Run(input []byte) ([]byte, error) {
	...
	return common.LeftPadBytes(crypto.Keccak256(pubKey[1:])[9:], 32), nil
}
