...
// Package chequebook package wraps the 'chequebook' Dnp smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in xdner; (auto)cashing cheques in xdner
// as well as (auto)depositing xdner to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/xdn/go-xdn/contracts/chequebook/contract"
	"github.com/xdn/go-xdn/core/types"
	"github.com/xdn/go-xdn/crypto"
	"github.com/xdn/go-xdn/log"
	"github.com/xdn/go-xdn/swarm/services/swap/swap"
)
...
// * depositing xdner to the chequebook
// * watching incoming xdner
...
// Cash cashes the cheque by sending an Dnp transaction.
