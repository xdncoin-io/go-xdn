...
// DeployReleaseOracle deploys a new Dnp contract, binding an instance of ReleaseOracle to it.
...
// ReleaseOracle is an auto generated Go binding around an Dnp contract.
...
// ReleaseOracleCaller is an auto generated read-only Go binding around an Dnp contract.
type ReleaseOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleTransactor is an auto generated write-only Go binding around an Dnp contract.
type ReleaseOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleSession is an auto generated Go binding around an Dnp contract,
...
// ReleaseOracleCallerSession is an auto generated read-only Go binding around an Dnp contract,
...
// ReleaseOracleTransactorSession is an auto generated write-only Go binding around an Dnp contract,
...
// ReleaseOracleRaw is an auto generated low-level Go binding around an Dnp contract.
type ReleaseOracleRaw struct {
	Contract *ReleaseOracle // Generic contract binding to access the raw methods on
}

// ReleaseOracleCallerRaw is an auto generated low-level read-only Go binding around an Dnp contract.
...
// ReleaseOracleTransactorRaw is an auto generated low-level write-only Go binding around an Dnp contract.
