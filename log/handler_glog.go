...
type GlogHandler struct {
	...
	override  uint32 // Flag whxdner overrides are used, atomically accessible
	backtrace uint32 // Flag whxdner backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whxdner this is the callsite
