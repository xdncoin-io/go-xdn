...
You always want to log a player's name and whxdner they're alive or dead, so when you create the player
object, you might do:
...
of whxdner the player is alive or not to each log message, so that the log records will reflect the player's
...
invalid arguments to the logging functions. You could, for example, wrap somxdning that is not
