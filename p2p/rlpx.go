...
import (
	...
	"github.com/xdn/go-xdn/crypto/secp256k1"
...
// and also verifies whxdner the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whxdner read packet had plain format.
