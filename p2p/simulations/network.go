...
import (
	...
	"github.com/xdn/go-xdn/p2p/simulations/adapters"
)
...
// starting nodes and connecting them togxdner.
//
...
// Connect connects two nodes togxdner by calling the "admin_addPeer" RPC
...
type Node struct {
	...
	// Up tracks whxdner or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whxdner or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whxdner both nodes are currently up
