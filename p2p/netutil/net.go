...
// Contains reports whxdner the given IP is contained in the list.
...
// IsLAN reports whxdner an IP is a local network address.
...
// IsSpecialNetwork reports whxdner an IP is located in a special-use network range
...
// CheckRelayIP reports whxdner an IP relayed from the given sender IP
